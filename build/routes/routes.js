...
const Revo365Routes = async function (fastify, opts) {
  ...
  fastify.delete(
    "/v2/stock/:id",
    { preHandler: [getSession] },
    stockRevoController.deleteStockRevoData
  );
  fastify.get(
    "/v2/stock/Archieve",
    { preHandler: [getSession] },
  ...
  fastify.get(
    "/wishlist/:userId",
    { preHandler: [getSession] },
    wishListController.getUserWishlistData
  );
  fastify.delete(
    "/wishlist/:id",
    { preHandler: [getSession] },
  ...
  fastify.post(
    "/wishlist",
    { preHandler: [getSession] },
    wishListController.upsertToWishlist
  );
  //users
  fastify.get(
    "/users",
  ...
  fastify.post(
    "/address",
    { preHandler: [getSession, validateRequestBody(inventoryusersSchema)] },
  ...
  fastify.post(
    "/delete/merchantid",
    { preHandler: [getSession] },
    ordersController.deleteBasedOnMerchantId
  );
  // Dashboard
  // orders - product_revo
  fastify.get(

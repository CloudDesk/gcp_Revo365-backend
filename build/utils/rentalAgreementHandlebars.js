...
Handlebars.registerHelper("defaultText", (value, fallback = "___________") => {
...
let _compiled = null;
export const getRentalAgreementTemplate = () => {
    if (_compiled)
        return _compiled;
    ...
    throw new Error("Rental agreement HTML template not found. Expected at: " +
        TEMPLATE_PATHS[0]);
};
//# sourceMappingURL=rentalAgreementHandlebars.js.map
...
import { insertEnquiryRecord, markEnquirySheetSynced, } from "./enquiryDB.service.js";
...
(function (enquiryService) {
     ...
     */
    enquiryService.enquiryCorporate = async (request) => {
        try {
     ...
     */
    enquiryService.enquiryIndividual = async (request) => {
        try {
            const payload = request.body;

...
const Revo365Routes = async function (fastify: FastifyInstance, opts: any) {
    ...
    fastify.post(
        ...
        { preHandler: [getSession, requireFinancePermission('create'), validateRequestBody(createChartAccountSchema)] },
    ...
    fastify.get('/dashboard/technician-ticket-count', { preHandler: [getSession] }, dashboardController.getTechnicianTicketCountData)

...
interface CountDashboardQuery {
    data?: string;
    [key: string]: string | string[] | undefined;
}

interface CountDashboardParams {
    objectName: string;
  }

export const dashboardController = {
    getPerMonthSalesData: async (request: FastifyRequest<{ Querystring: CountDashboardQuery }>, reply: FastifyReply) => {
        try {
    ...
    getSalesMonthlyData: async (request: FastifyRequest<{ Querystring: CountDashboardQuery }>, reply: FastifyReply) => {
        try {
    ...
    getSalesMonthlyLocationData: async (request: FastifyRequest<{ Querystring: CountDashboardQuery }>, reply: FastifyReply) => {
        try {
    ...
    getGroupedData: async (request: FastifyRequest<{ Querystring: CountDashboardQuery }>, reply: FastifyReply) => {
        try {
    ...
    getCountData: async (request: FastifyRequest<{ Querystring: CountDashboardQuery }>, reply: FastifyReply) => {
        try {
    ...
    getSalesGroupbyValuesData: async (request: FastifyRequest<{ Querystring: CountDashboardQuery }>, reply: FastifyReply) => {
        try {
    ...
    getDynamicSalesGroupbyValuesData: async (request: FastifyRequest<{ Querystring: CountDashboardQuery }>, reply: FastifyReply) => {
        try {
    ...
    getOrderStatusAmountQuantityData: async (request: FastifyRequest<{ Querystring: CountDashboardQuery }>, reply: FastifyReply) => {
        try {
    ...
    getOrderStatusQuantityData: async (request: FastifyRequest<{ Querystring: CountDashboardQuery }>, reply: FastifyReply) => {
        try {
    ...
    getCountDashboardData: async (request: FastifyRequest<{Querystring: CountDashboardQuery;Params: CountDashboardParams;}>,reply: FastifyReply
      ) => {
        try {
    ...
    getTicketCountData: async (request: FastifyRequest<{ Querystring: CountDashboardQuery }>, reply: FastifyReply) => {
        try {
    ...
    getEpochTicketCountData: async (request: FastifyRequest<{ Querystring: CountDashboardQuery }>, reply: FastifyReply) => {
        try {
    ...
    getEpochTicketCountLocationBasedData: async (request: FastifyRequest<{ Querystring: CountDashboardQuery }>, reply: FastifyReply) => {
        try {
    ...
    getTodayTicketPriorityCountData: async (request: FastifyRequest<{ Querystring: CountDashboardQuery }>, reply: FastifyReply) => {
        try {
    ...
    getTodayTicketTypeCountData: async (request: FastifyRequest<{ Querystring: CountDashboardQuery }>, reply: FastifyReply) => {
        try {
    ...
    getAvailableTotalAmountCountLocationBasedData: async (request: FastifyRequest<{ Querystring: CountDashboardQuery }>, reply: FastifyReply) => {
        try {
    ...
    getAvailableCountDataLocation: async (request: FastifyRequest<{ Querystring: CountDashboardQuery }>, reply: FastifyReply) => {
        try {
    ...
    getRevenueQuarterData: async (request: FastifyRequest<{ Querystring: CountDashboardQuery }>, reply: FastifyReply) => {
        try {
    ...
    getRevenueQuarterDataLocation: async (request: FastifyRequest<{ Querystring: CountDashboardQuery }>, reply: FastifyReply) => {
        try {
    ...
    getInvoiceData: async (request: FastifyRequest<{ Querystring: CountDashboardQuery }>, reply: FastifyReply) => {
        try {
    ...
    getInvoiceDateBasedData: async (request: FastifyRequest<{ Querystring: CountDashboardQuery }>, reply: FastifyReply) => {
        try {
    ...
    getSoldDetailsData: async (request: FastifyRequest<{ Querystring: CountDashboardQuery }>, reply: FastifyReply) => {
        try {
